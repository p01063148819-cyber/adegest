 ...
 */
export const registerBodySenhaMin = 6;

export const RegisterBody = zod.object({
  role: zod.enum(["admin", "vendedor"]),
  senha: zod.string().min(registerBodySenhaMin),
});
...
export const LoginResponse = zod.object({
  role: zod
    .union([zod.literal("admin"), zod.literal("vendedor"), zod.literal(null)])
    .nullable(),
});
...
export const ListStockMovementsResponseItem = zod.object({
  ...
  productId: zod.number(),
  productName: zod.string(),
  type: zod.enum(["entry", "exit", "adjustment", "sale", "cancellation"]),
  quantity: zod.number(),
...
export const GetDashboardStatsResponse = zod.object({
  ...
  todayRevenueVsYesterday: zod
    .number()
    .describe("Percentage variation vs. the same period yesterday"),
  todayAverageTicketVsYesterday: zod
    .number()
    .describe("Percentage variation vs. the same period yesterday"),
  todayCancelledCount: zod.number(),
  todayCancelledValue: zod.number(),
  ...
  recentStockMovements: zod.array(
    zod.object({
      id: zod.number(),
      productId: zod.number(),
      productName: zod.string(),
